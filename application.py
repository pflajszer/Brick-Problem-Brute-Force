...
def check_args():
    ...
    if len(sys.argv) != 3:
        raise TypeError(f"This app takes exactly 3 arguments ({len(sys.argv)} given). Usage: python app.py text_file.txt input_position")
...
def check_input_position(wall):
    """ Check if the input position is within the lenght of the given wall. """
